...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field spammed on 'Project'
        m2m_table_name = db.shorten_name('project_spammed')
    ...
    def backwards(self, orm):
        # Removing M2M table for field spammed on 'Project'
        db.delete_table(db.shorten_name('project_spammed'))
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'spammed': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'+'", 'blank': 'True', 'to': u"orm['auth.User']"}),
